...
require_grep 'environment-summary auto' docs/GUIDE.md
require_grep 'environment-summary TEXT\|auto' commands/autoresearch.md
...
require_grep 'plan --debug' references/binary-operations.md
require_grep 'shorthand for `--chain debug`' commands/autoresearch/plan.md
...
require_grep 'autoresearch-results/<mode>/' docs/GUIDE.md
require_grep 'autoresearch-results/<mode>/' references/binary-operations.md
require_grep 'autoresearch-results/debug' references/structured-output-spec.md
require_grep 'autoresearch-results/security' references/security-workflow.md
require_grep 'autoresearch-results/ship' references/ship-workflow.md
...
require_grep 'debug --depth <level> --iterations <n> --severity <level>' references/binary-operations.md
...
require_grep 'improve --depth <level> --iterations <n> --evals' references/binary-operations.md
require_grep 'improve --seeds <n> --discover|--no-discover --learn' references/binary-operations.md
require_grep 'shorthand for `--chain learn`' commands/autoresearch/improve.md
...
require_grep 'security --depth <level> --iterations <n> --diff --fix --evals' references/binary-operations.md
...
require_grep 'ship --auto --force --rollback --monitor <minutes> --learn' references/binary-operations.md
require_grep 'shorthand for `--chain learn`' commands/autoresearch/ship.md
...
require_grep 'scenario --domain <domain> --depth <level> --iterations <n> --evals --debug' references/binary-operations.md
require_grep 'test-scenarios \(default\), threat-scenarios, use-cases, user-stories' commands/autoresearch/scenario.md
require_grep 'shorthand for `--chain debug`' commands/autoresearch/scenario.md
...
require_grep 'reason --predict' references/binary-operations.md
require_grep 'shorthand for `--chain predict`' commands/autoresearch/reason.md
require_grep 'reason --iterations <n> --judges <n> --convergence <n>' references/binary-operations.md
...
require_grep 'autoresearch probe --subject .* --improve' references/binary-operations.md
...
require_grep 'probe --plan' references/binary-operations.md
require_grep 'shorthand for `--chain plan`' commands/autoresearch/probe.md
require_grep 'shorthand for `--chain improve`' commands/autoresearch/probe.md
