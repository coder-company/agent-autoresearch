...
- [ ] `git add Cargo.toml Cargo.lock docs/changelog.md .claude-plugin/plugin.json .claude-plugin/marketplace.json skills/autoresearch/SKILL.md .opencode/skills/autoresearch/SKILL.md .agents/skills/autoresearch/SKILL.md plugins/autoresearch`
