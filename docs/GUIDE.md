...
autoresearch evals --file autoresearch-results/results.tsv --format json --recommend --plateau-window 5
...
Use `autoresearch evals --file <path> --format json --recommend --plateau-window 5` after parallel closeout to include worker improvement counts, a sign-test summary, and CI-friendly next-step guidance.
