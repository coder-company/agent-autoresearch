...
Use `autoresearch scenario --target <feature> --domain web --depth deep --iterations 16 --evals --chain debug` to override the exploration budget and record domain, checkpoint metadata, and downstream handoff.
