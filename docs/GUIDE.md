...
Use `autoresearch evals --file <path> --format json --recommend` after parallel closeout to include worker improvement counts, a sign-test summary, and CI-friendly next-step guidance.
