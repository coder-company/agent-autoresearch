...
argument-hint: "[Topic: <text>] [Scope: <glob>] [--depth shallow|standard|deep] [--personas N] [--mode interactive|autonomous] [Iterations: N] [--plan] [--improve] [--evals]"
---
...
For autonomous mode, activate the completion condition:

```
/goal constraint saturation reached — fewer than {threshold} net-new constraints for 3 consecutive rounds, or stop after {iterations} turns
```
