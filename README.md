...
| `/autoresearch:evals` | Analyze past runs: trends, plateaus, anomalies, run comparison, parallel worker significance, `--recommend`, `--plateau-window`, and `--chain` guidance |
