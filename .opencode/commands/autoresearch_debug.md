...
```
/goal metric (cumulative confirmed findings) reaches <target or keeps finding new bugs>, as measured by the investigation loop, or stop after {iterations} turns
```
